...
```
cd existing_repo
git remote add origin https://gitlab.com/codegen4284011/suntravels.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/codegen4284011/suntravels/-/settings/integrations)
